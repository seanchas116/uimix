...
const menuClassNames = `text-macaron-text text-xs bg-macaron-background z-10 border border-macaron-uiBackground rounded shadow-lg overflow-hidden py-1 outline-0`;

const itemClassNames =
  "aria-disabled:text-macaron-disabledText h-6 outline-0 [&[data-active-item]]:bg-macaron-active pr-4 pl-6 flex items-center";
