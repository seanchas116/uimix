...
const menuClassNames = `text-macaron-text text-xs bg-macaron-background z-10 border border-macaron-uiBackground rounded shadow-xl overflow-hidden py-1 outline-0`;
